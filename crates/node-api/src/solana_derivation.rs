...
mod tests {
    ...
    fn escrow_program() -> [u8; 32] {
        [
            85, 33, 75, 86, 190, 213, 51, 181, 150, 15, 160, 251, 3, 216, 231, 4, 251, 108, 235,
            172, 165, 175, 110, 134, 44, 242, 212, 115, 49, 38, 126, 9,
        ]
    }
    fn usdc_mint() -> [u8; 32] {
        [
            59, 68, 44, 179, 145, 33, 87, 241, 58, 147, 61, 1, 52, 40, 45, 3, 43, 95, 254, 205, 1,
            162, 219, 241, 183, 121, 6, 8, 223, 0, 46, 167,
        ]
    }
    fn buyer() -> [u8; 32] {
        [
            69, 65, 206, 234, 127, 223, 72, 124, 40, 27, 21, 142, 229, 229, 236, 188, 213, 45, 163,
            33, 226, 113, 172, 50, 78, 130, 241, 1, 51, 244, 237, 134,
        ]
    }
    fn exp_buyer_ata() -> [u8; 32] {
        [
            58, 56, 53, 191, 165, 10, 140, 43, 196, 2, 242, 206, 125, 59, 36, 179, 99, 191, 56,
            103, 196, 199, 15, 63, 175, 241, 229, 68, 232, 250, 191, 170,
        ]
    }
    fn exp_contract() -> [u8; 32] {
        [
            227, 225, 181, 18, 35, 209, 168, 73, 158, 80, 161, 31, 117, 84, 106, 207, 14, 198, 114,
            172, 174, 249, 163, 81, 248, 90, 153, 142, 180, 88, 206, 135,
        ]
    }
    fn exp_escrow_ata() -> [u8; 32] {
        [
            207, 180, 84, 129, 115, 41, 124, 180, 222, 217, 94, 210, 159, 12, 204, 249, 184, 88,
            100, 75, 229, 20, 110, 79, 239, 169, 178, 160, 86, 231, 84, 170,
        ]
    }

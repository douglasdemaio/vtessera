...
**Remaining:** localhost discovery (mDNS or well-known endpoint). This is a
UX gap, not a security or correctness issue. The node works; the agent
just can't find it without knowing the port.
